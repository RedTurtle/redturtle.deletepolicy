...
print "*** Monkeypatched default permission for paste objects (from ModifyPortalContent to AddPortalContent) ***\n"
...
print "*** Monkeypatched default permission for cut objects (from ModifyPortalContent to DeleteObject) ***\n"